...
```
cd existing_repo
git remote add origin https://git.unistra.fr/ferreirarivier/projetprogramation_ferreira-rivier_julien.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.unistra.fr/ferreirarivier/projetprogramation_ferreira-rivier_julien/-/settings/integrations)
